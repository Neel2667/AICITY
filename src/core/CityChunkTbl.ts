...
export class CityChunkTbl {
    ...
    private isFixedCity: boolean = true; // Fixed bounded city mode - Harbor’s End (M2 - Persistent City - In Progress - Improving Chunk Quality)
    ...
    // This method is used as fallback only
